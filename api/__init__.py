...
def profile(patient_id, model, model_plugin_interface, phenotype_mapping_plugin_interface, timestamp):
    ...
    for clinical_feature_variable_object in clinical_feature_variable_objects:
        ...
        url = f"{pds_url_base}/{phenotype_mapping_plugin_interface}/mapping?patient_id={patient_id}&clinical_feature_variable={clinical_feature_variable}&timestamp={timestamp}"
        print(f"url = {url}")
